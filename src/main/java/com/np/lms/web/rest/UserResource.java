package com.np.lms.web.rest;

import com.np.lms.config.Constants;
import com.np.lms.domain.User;
import com.np.lms.repository.UserRepository;
import com.np.lms.security.AuthoritiesConstants;
import com.np.lms.service.MailService;
import com.np.lms.service.UserService;
import com.np.lms.service.dto.AdminUserDTO;
import com.np.lms.web.rest.errors.BadRequestAlertException;
import com.np.lms.web.rest.errors.EmailAlreadyUsedException;
import com.np.lms.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.np.lms.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
